/*
  ...
  - Made the column `position` on table `Lineup` required. This step will fail if there are existing NULL values in that column.
  - Made the column `shirtNumber` on table `Lineup` required. This step will fail if there are existing NULL values in that column.

*/
-- AlterTable
ALTER TABLE "Match" ADD COLUMN "awayPrimaryColour" TEXT;
ALTER TABLE "Match" ADD COLUMN "awaySecondaryColour" TEXT;
ALTER TABLE "Match" ADD COLUMN "homePrimaryColour" TEXT;
ALTER TABLE "Match" ADD COLUMN "homeSecondaryColour" TEXT;
